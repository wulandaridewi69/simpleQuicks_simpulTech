        ...
        <div className='task'>
          <div className='chatBox'>
            <div className='grid grid-cols-2'>
              ...
              <button className='m-auto'>New Task</button>
            </div>

            <div className='m-7 1'>
              <input id="link-checkbox" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
              <div className='flex items-baseline justify-between mb-4'>
                <p className='titleTask'>Set up documentation report for several Cases : Case 145443, Case 192829 and Case 182203</p>
                <div className='flex gap-5 items-center timeTask'>
                  <p>2 Days left</p>
                  <p>12/06/2021</p>
              ...
              <div className='flex items-center gap-2 mb-5'>
                ...
                <p className='taskDesc'>Closing off this case since this application has been cancelled. No one really understand how this case could possibly be cancelled. The options and the documents within this document were totally a guaranteed for a success!</p>
              </div>
            ...
            <div className='m-7 3'>
              <input id="link-checkbox" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
              <div className='flex items-baseline justify-between mb-4'>
                <p className='titleTask'>Set up appointment with Dr Blake</p>
                <div className='flex gap-5 items-center timeTask'>
                  <p>4 Days left</p>
                  <p>12/06/2021</p>
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
              ...
              <div className='flex items-center gap-2 mb-5'>
                ...
                <p className='taskDesc'>No Description</p>
              </div>
              <svg xmlns="http://www.w3.org/2000/svg" width="auto" height="2" viewBox="0 0 671 2" fill="none">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M671 1.5H0V0.5H671V1.5Z" fill="#828282" />
              </svg>
            ...
            <div className='m-7 4'>
              <input id="link-checkbox" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
              <div className='flex items-baseline justify-between mb-4'>
                <p className='done'>Contact Mr Caleb - video conference?</p>
                <div className='flex gap-5 items-center timeTask'>
                  <p>2 Days left</p>
                  <p>12/06/2021</p>
            ...
            <div className='m-7 5'>
              <input id="link-checkbox" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
              <div className='flex items-baseline justify-between mb-4'>
                <p className='done'>Assign 3 homework to Client A</p>
                <div className='flex gap-5 items-center timeTask'>
                  <p>2 Days left</p>
                  <p>12/06/2021</p>
                  <svg xmlns="http://www.w3.org/2000/svg" width="10" height="8" viewBox="0 0 10 8" fill="none">
