        ...
        <div className='task'>
          <div className='chatBox'>
            ...
            <div className='flex gap-2.5 mb-4'>
              ...
              <div className='flex items-baseline justify-between timeTask mb-4'>
                  <p>2 Days left</p>
                  <p>12/06/2021</p>
            ...
            <div className='m-7 2'>
              ...
              <div className='flex items-baseline justify-between mb-4'>
                <p className='done'>Set up documentation report for several Cases : Case 145443, Case 192829 and Case 182203</p>
